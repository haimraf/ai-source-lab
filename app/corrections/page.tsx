  ...
  return (
    <article>
      ...
      <ul>
        ...
        <li>כאשר מקור ישיר או פתוח מעבר לצילום מסך או כיתוב ויראלי משנה את מה שאפשר לקבוע בזהירות.</li>
      ...
      <p>אי הסכמה לבדה אינה טעות. כדי לשנות מסקנה צריך להציג מקור או טיעון שניתן לבדוק, לא רק עמדה אחרת, צילום מסך חוזר או כיתוב ויראלי בלי מקור פתוח.</p>
    </article>
  );
}
