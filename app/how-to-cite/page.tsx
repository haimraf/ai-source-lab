  ...
  return (
    <article>
      <section className="hero">
        ...
        <p className="lead">
          מקור בדיקה נועד לעזור להבין מה נטען, איזה מקור נמצא, איפה נוספה פרשנות, ומה אפשר לקבוע בזהירות. לכן ציטוט נכון צריך להפנות ל־<a className="text-link" href="/topics#all-checks">עמוד הבדיקה הספציפי</a> ולציין את תאריך העדכון.
        </p>
      </section>
      ...
      <section className="box verdict-box">
        <div className="verdict-grid">
          ...
          <div><span className="eyebrow">אם יש שינוי</span><p>שולחים מקור חדש דרך <a className="text-link" href="/corrections">עמוד התיקונים</a>.</p></div>
        </div>
      </section>
