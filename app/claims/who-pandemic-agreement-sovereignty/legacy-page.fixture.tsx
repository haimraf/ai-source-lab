...
${pageUrl}`;
  ...
  return (
    <article>
      ...
      <ClaimHeader claim={claim} verdictLabel="הסכם אמיתי — לא סמכות ישירה להכתיב מדיניות פנים" updatedLabel="נבדק ועודכן: 21 ביוני 2026" lead={lead} />

      <section className="box answer">
        <span className="eyebrow">תשובה קצרה</span>
        <h2>הסכם אמיתי — לא סמכות ישירה להכתיב מדיניות פנים.</h2>
        <p>
      ...
      <section className="box verdict-box">
        <div className="verdict-grid">
          <div><span className="eyebrow">הטענה</span><p>אמנת המגיפות נותנת ל-WHO סמכות להכתיב למדינות מדיניות פנים, חקיקה או צעדי חירום בזמן מגיפה.</p></div>
          <div><span className="eyebrow">מה כן נכון</span><p>ההסכם הוא מסגרת בינלאומית אמיתית שיכולה לחייב מדינות שיצטרפו אליה לפי ההליכים שלהן.</p></div>
          <div><span className="eyebrow">מה לא נמצא</span><p>לא נמצא סעיף שנותן ל-WHO סמכות ישירה להכתיב חוק, מדיניות פנים או צעדי חירום למדינה.</p></div>
          <div><span className="eyebrow">מסקנה</span><p><strong>הסכם אמיתי — לא סמכות ישירה להכתיב מדיניות פנים</strong></p></div>
        </div>
      </section>
      ...
      <div className="source-levels">
        ...
        <div className="source-level"><strong>מדינה</strong><div><h3>יישום דרך חוק פנימי</h3><p>מדינה שמצטרפת להסכם עדיין פועלת דרך מוסדותיה, חוקיה ותהליכי החתימה, האשרור או ההצטרפות שלה.</p></div></div>
        <div className="source-level"><strong>הטענה</strong><div><h3>כפייה של WHO</h3><p>כאן צריך סעיף שנותן ל-WHO סמכות להורות למדינה לבצע מדיניות פנים מסוימת. הסעיף שנבדק שולל זאת.</p></div></div>
      </div>
      ...
      <div className="comparison-list">
        ...
        <div><strong>יישום מקומי</strong><span>הוויכוח האמיתי במדינה יהיה על חתימה, אשרור, חקיקה ומדיניות מקומית, לא על הוראה ישירה של WHO.</span></div>
      </div>

      <h2>שרשרת הקפיצה</h2>
      <div className="logic-chain">
        <span>ההסכם יכול לחייב מדינות שמצטרפות אליו</span><span className="logic-arrow">←</span>
      ...
      <p className="small">הקפיצה היא להפוך תיאום בינלאומי ומסגרת מחייבת למדינות לסמכות ישירה של WHO על חוקי מדינה, בלי סעיף שנותן סמכות כזו. סעיף 22(2) אף שולל פרשנות כזאת.</p>
      ...
      <div className="faq-list">
        ...
        <details>
          <summary>איפה מתרחשת הקפיצה הלוגית?</summary>
          <p>הקפיצה היא לעבור מ-הסכם בינלאומי שיכול לחייב מדינות שיצטרפו אליו ל-WHO יכול להורות ישירות למדינה מה לעשות. בשביל הקפיצה הזאת צריך סעיף סמכות ברור, והסעיף שנבדק אומר את ההפך.</p>
        </details>
        <details>
          <summary>האם מותר לבקר את ההסכם?</summary>
          <p>כן. אפשר לבקר את מנגנוני המימון, השקיפות, תפקיד WHO, נספח PABS או ההשפעה על מדיניות מקומית. אבל ביקורת על ההסכם אינה הוכחה לכך ש-WHO מקבל סמכות כפייה ישירה על מדינות.</p>
        </details>
        <details>
