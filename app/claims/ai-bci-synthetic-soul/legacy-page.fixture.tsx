...
const sources = [
  { name: "Wired - Everything We Know About Neuralink's Brain Implant Trial", url: "https://www.wired.com/story/everything-we-know-about-neuralinks-brain-implant-trial", note: "מסביר ש-BCI אוסף אותות מוח, מנתח אותם ומתרגם אותם לפקודות לשליטה במכשיר חיצוני. הניסוי המתואר מכוון לאנשים עם שיתוק ולשליטה בסמן או מקלדת." },
  { name: "Reuters - Neuralink feasibility trial with brain implant and robotic arm", url: "https://www.reuters.com/business/healthcare-pharmaceuticals/musks-neuralink-launch-new-feasibility-trial-with-brain-implant-2024-11-25/", note: "מתאר ניסוי היתכנות שבו אנשים עם שיתוק משתמשים בממשק מוח-מחשב כדי לשלוט במכשירים חיצוניים, כולל בדיקה של זרוע רובוטית." },
  { name: "Wired - Neuralink first human subject demonstration", url: "https://www.wired.com/story/neuralink-implant-first-human-patient-demonstration", note: "מתאר הדגמה של שליטה במחשב באמצעות שתל BCI, ומדגיש שמדובר בטכנולוגיה ניסיונית שעדיין דורשת עבודה ומעקב." },
  { name: "Digital Twins: State of the Art Theory and Practice", url: "https://arxiv.org/abs/2011.02833", note: "סקירה על כפילים דיגיטליים כמערכות מודל, ניטור וסימולציה. לא מדובר בהעתקה של נשמה או תודעה אנושית." },
  { name: "What is a Digital Twin Anyway?", url: "https://arxiv.org/abs/2409.19005", note: "מאמר שמראה שגם להגדרת Digital Twin יש שונות ומגבלות, ושיכולות מתקדמות אינן בהכרח בשלות בכל תחום." },
  { name: "Adobe Firefly", url: "https://firefly.adobe.com/", note: "כלי יצירה גנרטיבי לתוכן. לא מערכת BCI ולא כלי שמפעיל גוף אנושי." },
];
  ...
  return (
    <article>
      ...
      <section className="box answer">
        <h2>שורה תחתונה</h2>
        <p>קיימות טכנולוגיות אמיתיות שמחברות בין מוח, מחשב ומכשירים חיצוניים. אבל במקורות שנבדקו לא נמצאה ראיה לכך ש־AI, BCI או כפיל דיגיטלי מאפשרים "נשמה סינטטית", השתלטות המונית על הגוף, או שליטה בבני אדם דרך LED, Wi-Fi, אנטנות או ריסוס.</p>
      ...
      <div className="comparison-list">
        ...
        <div><strong>Neurofeedback</strong><span>שיטה לאימון תגובות מוחיות בעזרת משוב. לא שליטה חיצונית באדם.</span></div>
      </div>

      <h2>שאלות נפוצות</h2>
      <div className="faq-list">
        <details><summary>אז BCI לא מסוכן בכלל?</summary><p>לא זו המסקנה. BCI הוא תחום רפואי וטכנולוגי רגיש, עם שאלות בטיחות, פרטיות ואתיקה. אבל סיכון או אתיקה אינם הוכחה להשתלטות המונית או ל"נשמה סינטטית".</p></details>
        <details><summary>האם AI יכול להפעיל רובוט או מחשב?</summary><p>כן, AI יכול להפעיל תוכנה, לסייע בשליטה במכשירים ולנתח מידע. זה שונה מהפעלת גוף אנושי במקום האדם.</p></details>
        <details><summary>מה לגבי כפיל דיגיטלי שמחקה אדם?</summary><p>אפשר לבנות מודלים שמחקים קול, סגנון כתיבה, דמות או הרגלים. זה לא אותו דבר כמו העתקת תודעה, זיכרונות מלאים או שליטה בגוף.</p></details>
        <details><summary>למה הטענה נשמעת משכנעת?</summary><p>כי היא משתמשת במונחים אמיתיים ומתקדמים. כשמחברים אותם מהר מדי, נוצרת תחושה שכל החלקים מוכיחים סיפור אחד. הבדיקה מפרידה בין החלקים.</p></details>
      </div>
      ...
      <section className="box method-note">
        ...
        <p>פירקנו את הטענה למונחים: BCI, AI Agents, Digital Twins, Neurofeedback וטענות על LED, Wi-Fi, אנטנות וריסוס. לאחר מכן בדקנו מה כל תחום באמת עושה, ומה לא נמצא במקורות שנבדקו. הבדיקה אינה עוסקת בשאלה רוחנית על קיום נשמה, אלא בטענה העובדתית שיש טכנולוגיה שמחליפה או מפעילה את התודעה האנושית.</p>
      </section>
    </article>
  );
}
