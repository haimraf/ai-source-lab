  ...
  return (
    <article>
      ...
      <div className="topic-grid">
        ...
        <a className="topic-card" href="/claims/cloud-seeding-chemtrails"><span className="topic-label">אשכול מתרחב</span><h3>שמיים, אקלים וסביבה</h3><p>שובלי התעבות, זריעת עננים, פליטות מנועים והקפיצה מטכנולוגיה קיימת לטענה על ריסוס.</p></a>
        ...
        <a className="topic-card" href="/about"><span className="topic-label">עתידי</span><h3>חוצנים ונרטיבים ציבוריים</h3><p>חשיפה, סרטים, תקשור, סיפורים ויראליים וההבדל בין חוויה, פרשנות ומקור שניתן לבדוק.</p></a>
