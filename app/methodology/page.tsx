export const metadata = {
  ...
  description: "השיטה שבה מקור בדיקה עובר מטענה ויראלית למסקנה מבוססת מקורות.",
};

const steps = [
  ["01", "מנסחים את הטענה", "לא בודקים תחושה כללית. כותבים במשפט אחד מה בדיוק נטען."],
  ["02", "מאתרים את המקור", "מחפשים את המסמך, ההודעה, התקן או הנתון שעליהם הטענה נשענת."],
  ["03", "קוראים את ההקשר", "בודקים מה נכתב לפני ואחרי הציטוט, מי פרסם ולמה."],
  ["04", "מפרידים בין שכבות", "מסמנים מה עובדה, מה פרשנות, מה אפשרי ומה פשוט לא נמצא."],
  ["05", "מפרסמים עם תאריך", "המסקנה מוצגת לצד המקורות ותאריך הבדיקה, כדי שאפשר יהיה לחזור אליה."],
  ["06", "מתקנים כשצריך", "מקור חדש או טעות משנים את העמוד. תיקון לא מוסתר אלא מתועד."],
];
  ...
  return (
    <article>
      <section className="hero">
        ...
        <p className="lead">המטרה היא לא לנצח ויכוח, אלא לאפשר לקורא לראות בעצמו מה המקור אומר ואיפה הסיפור התרחב מעבר אליו.</p>
      </section>
      ...
      <div className="box answer">
        <p>כלי בינה יכולים לסייע בחיפוש, מיון, תמלול וניסוח. הם לא נחשבים מקור, ולא מקבלים את ההחלטה הסופית. לפני פרסום נבדקים הקישורים, הציטוטים והמסקנה.</p>
      </div>
      ...
      <section className="box method-note">
        ...
        <p>אפשר לשלוח תיקון דרך עמוד התיקונים. הפנייה צריכה לכלול קישור מדויק והסבר קצר למה הוא משנה את המסקנה.</p>
