...
const migratedAiBciSyntheticSoulClaimContent = defineMigratedClaimContent({
  ...
  verdict: "טכנולוגיות BCI ו-AI קיימות — המקורות שנבדקו לא תומכים בטענת שליטה חיצונית בגוף",
  cluster: "ai-sources",
  updated: "2026-06-24",
...
אבל במקורות ובמקרי הבוחן שנבדקו כאן זה לא תומך בטענה על "נשמה סינטטית", השתלטות המונית על בני אדם, או שליטה דרך LED, Wi-Fi, אנטנות או ריסוס.
  ...
  body: [
    {
      ...
      paragraphs: [
        ...
        "הבדיקה אינה מכריעה את כל הסיכונים העתידיים של נוירוטכנולוגיה, פרטיות או ממשקי מוח־מחשב.",
      ],
      variant: "answer",
    },
    {
    ...
    },
    {
      ...
      note: "שלושת החלקים הראשונים מתארים תחומים אמיתיים. הקפיצה היא המעבר מהם לטענה טוטאלית על שליטה באוכלוסייה או החלפת תודעה. המקורות שנבדקו כאן לא תומכים בקפיצה הזאת.",
    },
    {
      id: "not-found",
      type: "comparison-list",
      title: "מה לא נמצא במקורות שנבדקו כאן?",
      items: [
    ...
    { id: "sources", type: "sources", title: "המקורות שנבדקו", source: "claim" },
    {
      ...
      paragraphs: ["פירקנו את הטענה למונחים: BCI, AI Agents, Digital Twins, Neurofeedback וטענות על LED, Wi-Fi, אנטנות וריסוס. לאחר מכן בדקנו מה כל תחום באמת עושה, ומה לא נמצא במקורות שנבדקו כאן. הבדיקה אינה עוסקת בשאלה רוחנית על קיום נשמה, ואינה מכריעה את כל הסיכונים העתידיים של התחום; היא בודקת את הטענה העובדתית שיש טכנולוגיה שמחליפה או מפעילה את התודעה האנושית."],
    },
  ],
