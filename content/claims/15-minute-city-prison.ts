...
const migratedFifteenMinuteCityPrisonClaimContent = defineMigratedClaimContent({
  ...
  verdict: "במקורות שנבדקו לא נמצא שמודל עיר 15 דקות מחייב כליאה או איסור יציאה מהשכונה",
  cluster: "agenda-2030",
  updated: "2026-06-24",
  ...
  shortAnswer: "לא לפי המקורות שנבדקו. הרעיון עצמו אינו כלא עירוני.",
  bottomLine: "במקורות שנבדקו לא נמצא מקור רשמי שמראה כליאה או איסור יציאה.",
  summaryPoints: [
  ...
  body: [
    {
      ...
      type: "answer-box",
      eyebrow: "תשובה קצרה",
      title: "לא לפי המקורות שנבדקו. הרעיון עצמו אינו כלא עירוני.",
      paragraphs: [
    ...
    },
    {
      id: "not-found",
      type: "comparison-list",
      title: "מה לא נמצא במקורות שנבדקו?",
      items: [
