...
const migratedOwnNothingClaimContent = defineMigratedClaimContent({
  ...
  verdict: "מאמר אמיתי באתר WEF — לא נמצא שזה ציטוט של שוואב או תוכנית הפקעת רכוש",
  cluster: "agenda-2030",
  updated: "2026-06-23",
  ...
  shortAnswer: "יש מקור למשפט, אבל לא נמצא שזה ציטוט של קלאוס שוואב או תוכנית רשמית להפקיע רכוש.",
...
export const ownNothingKlausSchwabClaimContent = defineClaim({
  ...
  lead: "המשפט ״לא יהיה לכם כלום ותהיו מאושרים״ הפך לאחד הסמלים הכי חזקים של טענות על אג׳נדה 2030 וה-WEF. יש לו גרעין אמיתי: היה פרסום כזה באתר WEF. השאלה היא האם זה מוכיח ציטוט של קלאוס שוואב או תוכנית רשמית לקחת רכוש — ושם המקור כבר לא מספיק.",
  shareCopy: `המשפט ״לא יהיה לכם כלום ותהיו מאושרים״ נשען על מאמר תרחישי שפורסם באתר WEF ונכתב על ידי Ida Auken. מהמקורות שנבדקו כאן לא עולה שזה ציטוט ישיר של קלאוס שוואב, סעיף רשמי באג׳נדה 2030 או תוכנית מדיניות להפקעת רכוש. הקפיצה היא מ״תרחיש עתידני״ ל״תוכנית אכיפה רשמית״.
  ...
  body: [
    {
      ...
      paragraphs: [
        ...
        "לכן המסקנה אינה ״אין שום מקור״. המסקנה המדויקת יותר היא: יש מקור לרעיון, אבל לא נמצא שהוא מוכיח ציטוט של שוואב או תוכנית רשמית לקחת בעלות פרטית מהציבור.",
      ],
      variant: "answer",
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "זה בדיוק המקום שבו צריך להפריד בין מקור אמיתי לבין ייחוס חזק יותר שלא מופיע באותו מקור.",
      ],
    },
    {
      id: "evidence",
