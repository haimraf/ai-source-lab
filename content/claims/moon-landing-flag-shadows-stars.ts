...
const migratedMoonLandingFlagShadowsStarsClaimContent = defineMigratedClaimContent({
  ...
  verdict: "מאפיינים חזותיים שמועלים כראיה — במקורות שנבדקו הם לא מספיקים להוכחת זיוף",
  ...
  shortAnswer: "לא. אלה מאפיינים חזותיים שדורשים הקשר, אבל במקורות שנבדקו לכל אחד יש הסבר צילום/סביבה סביר והם לא מספיקים כהוכחת זיוף.",
  bottomLine: "יש גרעין אמיתי: בתמונות אפולו אכן אין בדרך כלל כוכבים, הדגל נראה מקומט וזוויות הצל יכולות להיראות לא אינטואיטיביות. אבל המקורות והתיעוד הרחב מצביעים על הסברים פשוטים יותר: חשיפה לצילום באור שמש חזק, דגל עם מוט אופקי וקפלים, קרקע לא ישרה והיעדר אטמוספירה. הטענות האלה לא מספיקות כדי להוכיח שהנחיתה זויפה.",
  summaryPoints: [
    ...
    "הקפיצה: מעבר מ'צילום נראה לא אינטואיטיבי' ל'כל תוכנית אפולו זויפה'.",
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "צללים מושפעים משיפועי קרקע, עדשה, פרספקטיבה והחזרי אור מהקרקע ומהחליפות. צל שנראה לא אינטואיטיבי אינו מספיק כדי להוכיח תאורת אולפן.",
    },
    {
...
export const moonLandingFlagShadowsStarsClaimContent = defineClaim({
  ...
  lead: "הטענות על הדגל, הכוכבים והצללים מרגישות חזקות כי הן עובדות על אינטואיציה: ככה אנחנו רגילים שצילום נראה בכדור הארץ. אבל הירח הוא סביבת צילום אחרת. כדי להפוך מאפיין חזותי חריג לראיה לזיוף צריך להראות שהצילום לא יכול להתאים לסביבת ירח — ולא רק שהוא נראה לנו לא אינטואיטיבי.",
  shareCopy: `הדגל, הצללים והיעדר הכוכבים בתמונות אפולו לא מוכיחים שהנחיתה על הירח זויפה. יש כאן גרעין אמיתי: התמונות באמת נראות חריגות. אבל במקורות שנבדקו ההסברים הם חשיפה באור שמש חזק, דגל עם מוט אופקי, קפלים, פרספקטיבה וקרקע לא ישרה — לא ראיה מספקת לאולפן.
  ...
  body: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "הצללים נראים חריגים", text: "פרספקטיבה, קרקע לא ישרה והחזרי אור יכולים לשנות מראה של צללים." },
    ...
    },
    {
      ...
      items: [
        { label: "צילום לא אינטואיטיבי", text: "מראה שיש משהו שדורש הסבר, לא בהכרח זיוף." },
        ...
        { label: "מסקנה רחבה", text: "כדי לטעון זיוף צריך ראיה ישירה לאולפן, הפקה או סתירה בלתי ניתנת ליישוב — לא רק מאפיין חזותי חריג." },
      ],
    },
    {
      id: "logic",
      ...
      note: "החוליה האחרונה דורשת ראיה ישירה וחזקה בהרבה. מאפיין חזותי חריג יכול לפתוח בדיקה, אבל הוא לא מסיים אותה.",
    },
