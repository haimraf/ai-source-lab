...
const migratedKalElHebrewMeaningClaimContent = defineMigratedClaimContent({
  ...
  verdict: "קיימת הלימה לשונית ותרבותית; כוונה מפורשת לא הוכחה",
  ...
  faq: [
    ...
    { question: "למה לא להציג את זה כהוכחה?", answer: "כי הוכחה לכוונה דורשת מקור על כוונה: ראיון, מכתב, מסמך עיצוב או עדות ישירה של היוצרים. בלי זה נשארים עם הלימה לשונית ופרשנות תרבותית, לא עם מסר סודי מוכח." },
...
export const kalElHebrewMeaningClaimContent = defineClaim({
  ...
  shareCopy: `הקריאה של Kal-El כ\"קול אל\" או Voice of God היא פרשנות תרבותית מעניינת, במיוחד כי יוצרי סופרמן היו יהודים ויש סביב הדמות הקבלות ליהדות, משה וזהות כפולה. אבל בבדיקה לא נמצא מקור ישיר מסיגל או שוסטר שמאשר שזו הייתה הכוונה בשם. לכן יש כאן הלימה לשונית ותרבותית — לא הוכחה למסר סודי.
  ...
  body: [
    {
      ...
      type: "answer-box",
      eyebrow: "תשובה קצרה",
      title: "יש הלימה לשונית ותרבותית, אבל לא הוכחת כוונה.",
      paragraphs: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "כאן", text: "נמצאה הלימה לשונית ותרבותית, אבל לא מקור ישיר לכוונה מפורשת.", tone: "caution" },
      ],
    },
    {
      id: "method-note",
