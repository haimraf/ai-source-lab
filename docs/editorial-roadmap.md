...
12. ⏳ **feat: add read-only internal content status page** — עמוד פנימי/סטטי למוכנות claims, חוסרי metadata, sources, OG/share copy וצורך ברענון; טרם שולב בענף הנוכחי.
