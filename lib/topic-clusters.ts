...
export const topicClusters = [
  ...
  {
    slug: "public-health",
    path: "/topics/public-health",
    title: "בריאות ציבורית: מקור רפואי מול טענות רשת",
    shortTitle: "בריאות ציבורית",
    eyebrow: "🩺 אשכול חדש",
    description:
      "אשכול לטענות בריאות רגישות שבהן צריך להפריד בין מקור רפואי רשמי, מחקר ראשוני, רגולציה, תוסף או מוצר — לבין מסקנה טיפולית שמופצת ברשת.",
    status: "active",
    updated: "2026-06-23",
    priority: 0.86,
    claimSlugs: claimSlugs(["mrna-vaccines-dna-genome", "covid-supplements-vitamin-d-zinc-cure"]),
    plannedClaims: [
      {
        title: "האם רכיב שמופיע במחקר הוא אותו דבר כמו טיפול מאושר?",
        status: "בתכנון",
        note: "עמוד עזר שיפריד בין מחקר מעבדה, ניסוי קליני, המלצה רפואית ואישור רגולטורי.",
      },
      {
        title: "איך קוראים רשימת רכיבים של מוצר רפואי או תוסף?",
        status: "בתכנון",
        note: "לחבר בין עלון רשמי, רכיבים פעילים, חומרים בלתי פעילים וקפיצות סביב 'רעלים'.",
      },
      {
        title: "מתי טענת בריאות דורשת רופא ולא רק בדיקת מקור?",
        status: "בתכנון",
        note: "כלל אחריות עריכתית קבוע: מקור בדיקה אינו מחליף ייעוץ רפואי אישי.",
      },
    ],
    sourceMap: [
      ["מקור רפואי רשמי", "CDC, WHO, NIH, FDA, EMA, משרד בריאות או עלון מוצר רשמי שניתן לפתוח."],
      ["מחקר", "מאמר, סקירה או ניסוי קליני — חשוב, אבל לא תמיד המלצה טיפולית."],
      ["טענת רשת", "סרטון, פוסט או צילום מסך שהופכים רכיב, מחקר או חשש למסקנה רפואית חד-משמעית."],
    ],
    admin: {
      dashboardSection: "clusters",
      editorialStage: "taxonomy-approved-first-claim-batch",
      nextAction: "להוסיף רק קליימים צרים עם מקורות רפואיים רשמיים ולשמור על גבול ברור: לא ייעוץ רפואי אישי.",
    },
  },
  {
