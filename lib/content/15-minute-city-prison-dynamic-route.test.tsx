...
import LegacyPage, { metadata as legacyMetadata } from "../../app/claims/15-minute-city-prison/legacy-page.fixture";
...
describe("15-minute-city-prison dynamic route cutover", () => {
  it("registers only the existing public slug and resolves its internal content record", async () => {
    ...
    expect(html).toContain("לא נמצא מקור רשמי לכליאה או איסור יציאה");
